...
const CafeCard = ({ cafe, index, isSaved = false, onToggleSave, isVisited = false, onToggleVisited }: CafeCardProps) => {
  ...
  return (
    <div
      className="w-full text-left animate-fade-up rounded-2xl overflow-hidden bg-card border border-border shadow-sm hover:shadow-md transition-all duration-300"
